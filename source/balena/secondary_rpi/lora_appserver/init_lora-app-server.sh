...
ssh -oStrictHostKeyChecking=no -oUserKnownHostsFile=/dev/null -i odyslam_ubuntu.pem -fNT -R 8001:localhost:8001 -N ubuntu@150.140.184.241
echo 'Set reverse ssh tunneling 8001'
ssh -oStrictHostKeyChecking=no -oUserKnownHostsFile=/dev/null -i odyslam_ubuntu.pem -fNT -R 9000:localhost:8080 -N ubuntu@150.140.184.241
